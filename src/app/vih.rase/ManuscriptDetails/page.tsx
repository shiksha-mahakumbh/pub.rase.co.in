...
import ManuscriptDetailsComponent from '../../component/vih_Component/ManuscriptDetails'; // Path to the ManuscriptDetails component
import Login from '../../component/vih_Component/Login'; // Path to the Login component
import CompanyInfo from '../../component/vih_Component/CompanyInfo'; // Path to the CompanyInfo component
