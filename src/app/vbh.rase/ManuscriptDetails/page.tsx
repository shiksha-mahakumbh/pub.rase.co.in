...
import ManuscriptDetailsComponent from '../../component/vbh_Component/ManuscriptDetails'; // Path to the ManuscriptDetails component
import Login from '../../component/vbh_Component/Login'; // Path to the Login component
import CompanyInfo from '../../component/vbh_Component/CompanyInfo'; // Path to the CompanyInfo component
